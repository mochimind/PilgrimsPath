...
public class AgroPods extends Module {
	...
	public AgroPods(Ship _container) {
		super(_container);
		id = Module.AGRO_PODS;
	}
	...
	@Override public ResourceBundle operatingReward() {
		if (_operatingReward == null) {
			...
			_operatingReward.add(new Resource(Resource.FOOD_NAME, 30));
		}
	...
	@Override public String getName() { return "AgroPods"; }
