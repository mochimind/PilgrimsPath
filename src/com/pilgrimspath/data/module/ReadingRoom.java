...
public class ReadingRoom extends Module {
	...
	public ReadingRoom(Ship _container) {
		super(_container);
		id = Module.READING_ROOM;
	}
	...
	@Override public String getName() { return "Reading Room"; }
	
	@Override public int buildUnits() { return 5; }
	
	@Override public void onEnable(int count) {
		container.research.adjustResearchPerTick(count, ProjectType.Fundamental);
	}
